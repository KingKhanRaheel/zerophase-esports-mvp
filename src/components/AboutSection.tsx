        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-8 max-w-5xl mx-auto">
          {pillars.map((pillar, i) => (
            <motion.div
              ...
              className="game-card bg-card border border-border rounded-lg p-5 sm:p-8 hover:border-primary/30 transition-all duration-300 group"
            >
              <pillar.icon className="w-8 h-8 sm:w-10 sm:h-10 text-primary mb-4 sm:mb-5 icon-glow transition-all" />
              <h3 className="text-lg sm:text-xl font-heading font-bold mb-2 sm:mb-3">{pillar.title}</h3>
